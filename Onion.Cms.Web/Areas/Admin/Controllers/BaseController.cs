...
{
    public class BaseController<T> : Onion.Cms.Framework.Web.BaseController<T> where T : class
    {
        ...
        public Dictionary<string, (string Title, string Parent)> PageInfo = new Dictionary<string, (string Title, string Parent)>
        {
            ...
            {"/admin/brand/create" ,("افزودن برند","/admin/brand/index")},
            {"/admin/brand/edit" ,("ویرایش برند","/admin/brand/index")},
