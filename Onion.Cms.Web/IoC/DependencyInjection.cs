...
namespace Onion.Cms.Web.IoC
{
    public static class DependencyInjection
    {
            ...
            IConfiguration configuration)
        {
            ...
            var baseUrl = configuration.GetValue<string>("ApiPathConfig:BaseUrl");
            ...
            //services.AddHttpClient<IClient, Client>(x=>x.Timeout=TimeSpan.FromSeconds(60000));
            services.AddScoped<IRestClient>(provider => new RestApiClient(baseUrl));
            ...
            #endregion
            services.Configure<ApiPath>(configuration.GetSection("ApiPathConfig"));
