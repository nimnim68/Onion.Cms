...
using Onion.Cms.Domain.Common.Entity;
...
using Onion.Cms.Domain.Chats.Entities;
using Onion.Cms.Domain.Stores.Entities;

namespace Onion.Cms.DAL.Context
{
    public class DatabaseContext : IdentityDbContext<ApplicationUser, ApplicationRole, int>
    {
        ...
        private void ApplyQueryFilter(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>().HasQueryFilter(x => !x.IsRemoved);
